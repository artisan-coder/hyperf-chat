...
<template id="tpl">
    <section>
                ...
                <div class="webTalk-panel" v-show="menu=='about'">
                    <div class="webTalk-about-box">
                        ...
                        <ul class="webTalk-about-list">
                            ...
                            <li><span>GitHub：<a :href="author.repositoriesUrl"
                                                target="_blank">@{{author.repositoriesUrl}}</a></span></li>
                            <li><span>邮箱：@{{author.email}}</span></li>
                            <li>
                  <span class="">
                    <a :href="author.repositoriesUrl" target="_blank">
                      <img :src="'https://img.shields.io/github/stars/'+author.userName+'/'+author.repositoriesName+'?label=Star&amp;style=flat&amp;logo=github'"
                           alt="" style="vertical-align: middle;">
                    </a>
                    <a :href="author.repositoriesUrl" target="_blank">
                      <img :src="'https://img.shields.io/github/forks/'+author.userName+'/'+author.repositoriesName+'?label=Fork&amp;style=flat&amp;logo=github'"
                           alt="" style="vertical-align: middle;">
                    </a>
                  </span>
                            </li>
        ...
        <div class="wChat-copyright">CopyRight Powered By artisan-coder ©2020</div>
    </section>
</template>
<template id="message">
